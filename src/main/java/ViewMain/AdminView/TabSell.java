...
public class TabSell extends JPanel {
    ...
    private SellJbut sellJbut = new SellJbut(this);
    ...
    public void initj(){
        ...
        jButton2 = new JButton("Create Bill");
        jButton3 = new JButton("Customerr");
        jPanel1 = new JPanel();
        jPanel2 = new JPanel();
        ...
        jButton1.addActionListener(sellJbut);
        jButton2.addActionListener(sellJbut);
        jButton3.addActionListener(sellJbut);
        jTextField1.getDocument().addDocumentListener(sellJbut);
        ...
        selectionModel.addListSelectionListener(sellJbut);
